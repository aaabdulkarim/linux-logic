...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            commands = {
                "garten_betreten": "mkdir -p /home/Garten && cd /home/Garten && ls",
                "garten_reinigen": "rm -f /home/Garten/Unkraut*.txt",
                "blumen_pflanzen": "touch /home/Garten/Zauberblume1.txt /home/Garten/Zauberblume2.txt",
                "garten_verzaubern": "chmod 644 /home/Garten/Zauberblume*.txt"
            }
...
@app.get("/")
async def root():
    return {"message": "WebSocket für Docker-Interaktion im verzauberten Garten läuft"}
